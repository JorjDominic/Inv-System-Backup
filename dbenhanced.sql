...
ALTER TABLE Users
MODIFY RoleID INT NOT NULL DEFAULT 5;
SELECT * FROM users;
...
-- Update payment methods with more options
DELETE FROM PaymentMethods;
INSERT INTO PaymentMethods (MethodName, Description, RequiresVerification)
VALUES 
...
CREATE TABLE Orders (
    ...
    OrderStatus ENUM('pending', 'processing', 'paid', 'shipped', 'delivered', 'cancelled', 'refunded') NOT NULL DEFAULT 'pending',
...
-- Update Orders table to include pickup-specific statuses
ALTER TABLE Orders 
...
ADD COLUMN PickupTime TIME NULL,
ADD COLUMN PickupCode VARCHAR(10) NULL,
ADD COLUMN PickupNotes TEXT NULL;

-- Update Orders table to make PickupTime nullable
ALTER TABLE Orders 
MODIFY COLUMN PickupTime TIME NULL

;ALTER TABLE Orders MODIFY COLUMN ReferenceNumber VARCHAR(255) NULL;
